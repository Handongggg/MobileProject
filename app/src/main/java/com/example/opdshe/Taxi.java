...
public class Taxi extends AppCompatActivity implements View.OnClickListener {
    ...
    public void postFirebaseDatabase(boolean add){
       /* mPostReference = FirebaseDatabase.getInstance().getReference();
        ...
        childUpdates.put("/POST/" +, postValues);
        ...
        switch (v.getId()) {
            case R.id.btn_insert:
                ...
                if(!IsExistID()){
                    ...
                    Toast.makeText(Taxi.this, "이미 존재하는 ID 입니다. 다른 ID로 설정해주세요.", Toast.LENGTH_LONG).show();
                }
